  ...
  <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
    <div class="">
      <div class="flex items-center justify-between pb-4">
        ...
        <div @click="showNewTransactionForm" class="text-grey-lightest text-xs font-bold bg-green hover:bg-green-light rounded border-b-4 border-green-dark hover:border-green py-2 px-4 hidden md:inline-flex items-center">
      ...
      <div class="-mx-2">
        ...
        <div @click="showNewTransactionForm" class="text-grey-lightest text-xs font-bold bg-green hover:bg-green-light rounded border-b-4 border-green-dark hover:border-green py-2 px-4 inline-flex items-center justify-center w-full md:hidden my-2">
          <svg class="fill-current w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M11 9V5H9v4H5v2h4v4h2v-4h4V9h-4zm-1 11a10 10 0 1 1 0-20 10 10 0 0 1 0 20z"/></svg>
          Add transactions
        </div>
      </div>
